...
EREN_IMG = "https://telegra.ph/file/2ed2550053c1ae60b167b.jpg"
                    ...
                    [
                        [
                            InlineKeyboardButton(
                                ...
                                url="t.me/GojoSataro_Robot?startgroup=true".format(
                ...
                reply_markup=InlineKeyboardMarkup(
                    [
                        [
                            InlineKeyboardButton(
                                text="Help",
                                url="t.me/GojoSataro_Robot?start=help_{}".format(
...
def main():
    ...
    if SUPPORT_CHAT is not None and isinstance(SUPPORT_CHAT, str):
        try:
            dispatcher.bot.sendMessage(f"@{SUPPORT_CHAT}", "[I am now Alive!](https://telegra.ph/file/7715a43a45d234154e929.mp4)", parse_mode=ParseMode.MARKDOWN)
        except Unauthorized:
            LOGGER.warning(
