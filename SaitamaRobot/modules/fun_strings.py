...
ABUSE = (
    ...
    "Hizda hai tu",
    "Owww ... Abey bhosdike.",
    "Graand mai mobile rakhke typing kar raha hai.",
    "Ek kaam kar gaand mai batti daal le.",
    "Command not found. Just like your brain.",
    "Bhadwe.",
    "Tujhse accha toh mera lawda.",
    "Section 9 ke tahet tumhe apni gaand har roj marwani padegi.",
    "Sorry, mai tumhari gaand nahi kharid sakta.",
    "Mujhpe vishwas karo mai hi tera baap ho.",
    "Baap se muh ladata hai.",
